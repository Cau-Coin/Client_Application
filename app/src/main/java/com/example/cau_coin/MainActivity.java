...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myList.clear();
        myList.add(new RecycleItem("1", "1", "선형대수학", "2017","1"));
        myList.add(new RecycleItem("2", "1", "자료구조", "2018","2"));
        myList.add(new RecycleItem("2", "2", "컴퓨터구조", "2018","3"));
        myList.add(new RecycleItem("4", "1", "캡스톤디자인", "2018","4"));
        myList.add(new RecycleItem("4", "2", "설계패턴", "2018","5"));
        myList.add(new RecycleItem("4", "2", "영상처리", "2018","6"));
    ...
    class MyAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ((ViewHolder) holder).cardview_text.setText("["+mItems.get(position).getTakeYear()+"년 수강자] "+mItems.get(position).getGrade() + "학년 " + mItems.get(position).getSemester() + "학기 " + mItems.get(position).getSubject());
        }
